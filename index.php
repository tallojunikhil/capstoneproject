...
<head>
	...
	<title>CodeX: An automated programming judge</title>
...
<body class="landing">
   ...
   <nav class="navbar navbar-inverse navbar-fixed-top">
	...
	<div class="container-fluid">
       <div class="col-sm-6 pull-left">
          <h1>CodeX</h1>
          <p>CodeX is an intelligent platform to automate programming assignments on the cloud.
	...
	<section class="features features-student container-fluid text-center">
		...
		<div class="row">
            <h2><strong>CodeX for Students</strong></h2>
		  <div class="col-lg-4">
		    <img class="feature-img" src="assets/images/list.png" alt="Practice online">
		    <h2>Practice Online</h2>
		    <p>CodeX provides an online platform for students to practice programming assignments online. Complete assignments, keep track of your scores, progress and flaunt them to your peers!</p>
		  </div><!-- /.col-lg-4 -->
		  <div class="col-lg-4">
   ...
   <section class="features features-school container-fluid text-center">
		<!-- Three columns of text below the carousel -->
		<div class="row">
           <h2><strong>CodeX for Schools</strong></h2>
		  <div class="col-lg-4">
		    <img class="feature-img" src="assets/images/code.png" alt="coding platofrm">
		    <h2>Coding Platform</h2>
		    <p>CodeX is an online platform for colleges and universities as well as employers to host hackathons, code competitions and programming assignments online and grade them remotely.</p>
		  </div><!-- /.col-lg-4 -->
		  <div class="col-lg-4">
