...
<head>
	...
	<title>CODEX: An automated platform for Functional Programming </title>
...
<body class="landing">
   ...
   <nav class="navbar navbar-inverse navbar-fixed-top">
      <div class="container">
         <div class="navbar-header">
            ...
            <a class="navbar-brand" href="">Code<u>X</u></a>
         </div>
	...
	<div class="container-fluid">
       <div class="col-sm-6 pull-left">
          ...
          <h2>Built for You</h2>
          <br><br>
          <p>Code<u>X</u> is an intelligent platform to automate Functional Programming on the cloud. Built for You, it primarily aims to provide a place for you to practice and learn coding challenges and improve their skills.</p>
          ...
          <p>Sign Up and start <strong>Coding</strong> right away.</p>
       </div>
       <div class="col-sm-4 pull-right">
          <form action="/register/" method="post" class="clearfix entry-form">
             ...
             <div class="form-group">
                <label for="input-dept">Stream</label>
             ...
             <div class="form-group">
                ...
                <p class="help-block">If you are a student, Please enter 14300 as SecureID</p>
             </div>
	...
	<section class="features features-student container-fluid text-center">
		...
		<div class="row">
            <h2><strong>Code<u>X</u> for You</strong></h2>
		  <div class="col-lg-4">
		    <img class="feature-img" src="assets/images/list.png" alt="Practice online">
		    <h2>Practice Online</h2>
		    <p>Code<u>X</u> provides an online platform for You to practice programming assignments online. Complete assignments, keep track of your scores, progress and flaunt them to your peers!</p>
		  </div><!-- /.col-lg-4 -->
		  <div class="col-lg-4">
		    <img class="feature-img" src="assets/images/code.png" alt="Monthly Challenge">
		    <h2>Monthly Challenge</h2>
		    <p>Our Unique program for a month will help you to excel in your programming. Challenge  will be sent to registered email id by student every day for 30 days</p>
             <h4>(Coming Soon!)</h4>
		  </div>
      <div class="col-lg-4">
   ...
   <section class="features features-school container-fluid text-center">
		<!-- Three columns of text below the carousel -->
		<div class="row">
           <h2><strong>Code<u>X</u> for Schools</strong></h2>
		  <div class="col-lg-4">
		    <img class="feature-img" src="assets/images/code.png" alt="coding platofrm">
		    <h2>Coding Platform</h2>
		    <p>Code<u>X</u> is an online platform for colleges and universities as well as employers to host hackathons, code competitions and programming assignments online and grade them remotely.</p>
		  </div><!-- /.col-lg-4 -->
		  <div class="col-lg-4">
